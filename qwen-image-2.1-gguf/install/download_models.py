#!/usr/bin/env python3
"""Download pinned GGUF and companion weights and verify every byte with SHA-256."""
import argparse
import hashlib
import json
...
def main():
    ...
    for spec in missing:
        ...
        got = Path(hf_hub_download(repo_id=MANIFEST['repository'], filename=spec['source'], revision=MANIFEST['revision'], local_dir=dest))
