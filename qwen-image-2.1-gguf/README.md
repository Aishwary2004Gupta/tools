# Qwen-Image-2.1 GGUF on one GPU
...
[Русский гайд](README.ru.md) · [Give this file to an agent](INSTALL-WITH-AGENT.md) · [Memory and validation](docs/validation.md)
...
This is a separate setup from the [native INT8 guide](../qwen-image-2.1/README.md).
...
and key Python packages in [versions.json](install/versions.json). It creates a
...
below, then restart when the queue is idle. From this guide's folder, copy UI
workflows with:
...
[models.json](install/models.json). It resumes downloads through Hugging Face
...
From this guide's directory, using the installed environment:
...
[Original validation PNGs](examples/README.md) include the red teapot, edits,
and transparent output.

![Q4_K_M text-to-image result](examples/qwen21-example.png)
...
- [Original INT8 installation](../qwen-image-2.1/README.md)
